# Personal Reflection: AI Coding and Development Tools

## What Surprised Me Most

Before starting this research, I expected AI coding tools to be mostly autocomplete systems — slightly smarter versions of what IDEs already do. What surprised me was how far they have already gone beyond that. Tools like Cursor can understand multiple files at once and make changes across an entire codebase based on a single natural language instruction. That is not autocomplete — that is a different relationship between developer and code.
...
There is also the question of skill development. If I use AI to write every function during my early career, will I actually learn how to program? Or will I learn how to prompt? These feel like different skills, and I am not sure both are equally valuable in the long run.
...
After completing this research, my conclusion is that the most important thing I can do as a developing engineer is to stay in control of my understanding. I want to use AI tools actively, but I also want to maintain the habit of reading what they generate, questioning it, and understanding it before I accept it.

I also think the skills that will matter most in an AI-assisted world are the ones AI cannot do: understanding what the user actually needs, designing systems that are maintainable by a team, reviewing AI-generated code critically, and making architectural decisions that account for real-world constraints.

AI does not know that our server budget is limited, or that the team maintaining this code next year will be junior developers, or that the client changes their mind every two weeks. Those are human concerns, and solving them requires human judgment.
